//
//  AddBuildExpenseViewModel.swift
//  Expenso
//
...
class AddBuildExpenseViewModel: ObservableObject {
    ...
    func saveTransaction(managedObjectContext: NSManagedObjectContext) {
        ...
        if amountStr.isEmpty || amountStr == "" {
            ...
            guard let amount3 = Int(amountStr3) else {
                alertMsg = "Wpisz w liczbie dni wolnych 0 jeśli takich danyc zakres zaszu nie posiada"; showAlert = true
                return
            }
...
/*
struct AddBuildExpenseViewModel_Previews: PreviewProvider {
    static var previews: some View {
        AddBuildExpenseViewModel()
    }
}
*/
