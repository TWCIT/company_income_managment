...
public class ExpenseCD: NSManagedObject, Identifiable {
    ...
    @NSManaged public var paidIs: Bool
    @NSManaged public var occuredOn: Date?
    @NSManaged public var occuredTo: Date?
    @NSManaged public var note: String?
    @NSManaged public var amount: Double
    @NSManaged public var amount2: Double
    @NSManaged public var amount3: Int64
    @NSManaged public var imageAttached: Data?
    @NSManaged public var expanseBuild: BuildCD?
    @NSManaged public var expanseWorker: WorkerCD?
}
