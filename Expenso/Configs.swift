...
// App Globals
let APP_NAME = "IVG"
let APP_LINK = "Przez Darusza Kubów"
let SHARED_FROM_EXPENSO = """
    Udostępnione z \(APP_NAME) APP: \(APP_LINK)
    """
// IMAGE_ICON NAMES
...
func getTransTagTitle(transTag: String) -> String {
    switch transTag {
        ...
        case TRANS_TAG_FOOD: return "Jedzenie"
        case TRANS_TAG_HOUSING: return "Mieszkanie"
        case TRANS_TAG_INSURANCE: return "Ubezpieczenie"
        case TRANS_TAG_MEDICAL: return "Zdrowotne"
        case TRANS_TAG_SAVINGS: return "Oszczędności"
        case TRANS_TAG_PERSONAL: return "Osobiste"
        case TRANS_TAG_ENTERTAINMENT: return "Pracownik"
        case TRANS_TAG_OTHERS: return "Inne"
        case TRANS_TAG_UTILITIES: return "Materiały"
